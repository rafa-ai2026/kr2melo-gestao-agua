(() => {
  ...
  function save(message = '') { try { localStorage.setItem(KEY, JSON.stringify(state)); if (message) toast(message); return true; } catch { toast('Não foi possível salvar. Faça backup e libere espaço no navegador.', true); return false; } }
