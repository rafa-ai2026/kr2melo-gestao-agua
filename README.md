...
- Documento usa logo, assinatura, apresentacao do servico e beneficios.
- Botao para salvar em PDF/imprimir e link para envio por e-mail.

---

## Atualizacao v5.3.13 - Carta de apresentacao
...
## Atualizacao v5.3.15 - Sincronizacao, PIN e seguranca

- Mobile ganhou botoes para enviar e baixar dados da nuvem manualmente.
- Configuracoes ganhou cadastro/troca do PIN administrativo usado no mobile.
- Configuracoes ganhou botao para reordenar apartamentos pela rota fisica.
- Alteracoes por apartamento agora ficam registradas em historico consultavel na tela Unidades.
- O site avisa quando uma nova versao foi carregada e solicita atualizacao da pagina se houver cache antigo.
- Textos com acentuacao foram conferidos para evitar exibicao quebrada no navegador.

---

## Atualizacao v5.3.16 - Multas/outros e estrategia da agua

- Tela Leituras ganhou lista rapida de apartamentos com multa/outros, com valor, descricao e observacao.
- Conferencia da conta global ganhou recomendacao para sanar a conta de agua com base na conta real, leituras e consumo total.
...
## Atualizacao v5.3.18 - Grade fisica de 4 apartamentos no mobile

- Lista de apartamentos no mobile agora fica sempre em linhas de 4.
- A rota visual segue a instalacao: 01, 11, 21, 31; depois 02, 12, 22, 32; e assim por diante.
- Removidas quebras automaticas que mudavam para 6 colunas em telas largas ou 3 colunas em telas pequenas.
- Botoes da lista foram compactados para manter 4 por linha sem estourar no celular.
